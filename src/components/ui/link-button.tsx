...
const classes = {
  ...
  normal:
    "bg-green-600 text-light border border-transparent hover:bg-green-800",
  outline:
    "border border-border-400 bg-transparent hover:text-light hover:bg-green-800 hover:border-green-800",
  disabled:
